...
dat_name="blackchancery.pl"
dat_dir="BlackChanceryObj"
...
echo "Erzeuge die include Dateien\n"
for i in $Buchstaben
do
    obj2opengl.pl -noscale -nomove "$dat_dir/$i.obj" -o "$i.h" -noverbose
done
